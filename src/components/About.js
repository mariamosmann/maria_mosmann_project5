        ...
        return (
            <section className="about">
                <div className="about__wrapper wrapper">
                    ...
                    <ul class="about__socialmedia socialmedia">
                        <li class="socialmedia__item">
                            <a href="http://www.tuni.tech" class="socialmedia__link">
                                <span class="sr-only">Tuni's site.</span>
                                <i class="fas fa-tv"></i>
                            </a>
                        </li>

                            <li class="socialmedia__item">
                                <a href="mailto:tuni.webdev@gmail.com" class="socialmedia__link">
                                    <span class="sr-only">Tuni's Email.</span>
                                    <i class="far fa-envelope"></i>
                                </a>
                            </li>                            

                            <li class="socialmedia__item">
                                <a href="https://www.linkedin.com/in/tuni/" target="_blank" class="socialmedia__link">
                                    <span class="sr-only">Tuni's LinkedIn.</span>
                                    <i class="fab fa-linkedin-in socialmedia__icon"></i>
                                </a>
                            </li>                            
                        
                            <li class="socialmedia__item">
                                <a href="https://twitter.com/tuni_tech" target="_blank" class="socialmedia__link">
                                    <span class="sr-only">Tuni's Twitter.</span>
                                    <i class="fab fa-twitter socialmedia__icon"></i>
                                </a>
                            </li>
                        
                            <li class="socialmedia__item">
                                <a href="https://github.com/tunimosmann" target="_blank" class="socialmedia__link">
                                    <span class="sr-only socialmedia__icon">Tuni's GitHub.</span>
